...
const ListRecipeBeef = () => {
    const navigate = useNavigate()

    const [beef, setBeef] = useState([])
    const fetchData = async () => {
    const res = await axios.get('https://www.themealdb.com/api/json/v1/1/search.php?s=Beef')
    setBeef(res.data.meals)
    }
